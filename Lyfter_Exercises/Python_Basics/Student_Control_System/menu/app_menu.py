...
from menu.actions import enter_students_info, view_overall_average, view_top3_highest_grade_average, view_students_info
...
def run_menu():
    ...
    while True:
        ...
        print("3. View top 3 highest grade average.")
        ...
        if menu_option == 1:
            ...
            view_top3_highest_grade_average(students_list)
        elif menu_option == 4:
